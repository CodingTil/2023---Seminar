...
\scriptsize Source:\thinspace{\small\itshape Laksono Adhianto et al. “HPCToolkit: Tools for performance analysis of optimized parallel programs”. In: Concurrency and Computation: Practice and Experience 22.6 (2010), pp. 685-701.}
\end{column}
\end{columns}
\end{frame}
...
\end{column}
\begin{column}{0.23\textwidth}
\scriptsize Source:\thinspace{\small\itshape Philipp Schaad, Tal Ben-Nun, and Torsten Hoefler. “Boosting performance optimization with interactive data movement visualization”. In: arXiv preprint arXiv:2207.07433 (2022).}
\end{column}
\end{columns}
\end{frame}
...
\begin{column}{0.76\textwidth}
\centering
\includegraphics[height=0.75\textheight]{logos/memaxes_cache.png}
\end{column}
\begin{column}{0.23\textwidth}
\scriptsize Source:\thinspace{\small\itshape Alfredo Giménez et al. “Memaxes: Visualiza- tion and analytics for characterizing complex memory performance behaviors”. In: IEEE transactions on visualization and computer graphics 24.7 (2017), pp. 2180-2193.}
\end{column}
\end{columns}
\end{frame}
...
\begin{frame}{Boosting Performance Optimization with Interactive Data Movement Visualization}
\begin{columns}[T]
\begin{column}{0.76\textwidth}
\centering
\includegraphics[height=0.84\textheight]{logos/small.png}
...
\item[\faBook] Laksono Adhianto et al. “HPCToolkit: Tools for performance analysis of optimized parallel programs”. In: \textit{Concurrency and Computation: Practice and Experience} 22.6 (2010), pp. 685-701.
\item[\faBook] Alfredo Giménez et al. “Memaxes: Visualiza- tion and analytics for characterizing complex memory performance behaviors”. In: \textit{IEEE transactions on visualization and computer graphics} 24.7 (2017), pp. 2180-2193.
\item[\faBook] Philipp Schaad, Tal Ben-Nun, and Torsten Hoefler. “Boosting performance optimization with interactive data movement visualization”. In: \textit{arXiv preprint arXiv:2207.07433} (2022).
\end{itemize}
\end{frame}
